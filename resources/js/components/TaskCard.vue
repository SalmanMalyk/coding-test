<template>
    <div
        :class="[
            'w-full  text-gray-900 shadow-md rounded-lg p-3 pb-8 mb-4 relative',
            { 'bg-green-200': task.completed_at !== null }, // completed tasks
            { 'bg-white': task.completed_at === null }, // incomplete tasks
        ]"
    ...
    >
        {{ task.name }}<br />
        <div class="text-xs text-gray-500 absolute bottom-2">
            {{ task.user.name }}
        </div>
        <img
